...
const commissionSnapshotSchema = new mongoose.Schema(
  {
    ...
    agentCreatedSales: { type: Number, default: 0 },
    assignedSales: { type: Number, default: 0 },
    agentCreatedLeadCount: { type: Number, default: 0 },
    agentCreatedCommission: { type: Number, default: 0 },
    assignedCommission: { type: Number, default: 0 },
...
commissionSnapshotSchema.index(
  { agentEmail: 1, monthKey: 1 },
  { unique: true },
);
